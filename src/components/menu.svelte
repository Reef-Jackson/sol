  <ul class="fixed z-10 m-2 rounded-2xl menu bg-base-200">
    <li>
    ...
    <li>
      <a href="#work" class="tooltip tooltip-right" data-tip="Projects">
    ...
    <li>
      <a class="tooltip tooltip-right" data-tip="My Stack">
